"""Java language parser abstraction stub."""
...
class JavaParser(LanguageParser):
    """Parser abstraction stub for Java source files.

    Concrete tree-sitter AST extraction logic will be implemented in TASK-2B.
    """
